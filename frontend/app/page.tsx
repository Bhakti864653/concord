  ...
  return (
    <main className="relative flex min-h-screen flex-1 items-center overflow-hidden px-6 py-10 sm:px-12 sm:py-16">
      ...
      <div className="relative mx-auto flex w-full max-w-6xl flex-1 flex-col justify-center gap-8 sm:max-w-none">
        ...
        <div className="flex flex-col gap-8 sm:max-w-md">
          ...
          <div className="flex gap-3">
            <Link
              href="/signup"
              className="rounded-xl bg-mentee px-5 py-2.5 font-bold text-paper-raised transition-opacity hover:opacity-90"
            >
              Sign up
            </Link>
            <Link
              href="/login"
              className="rounded-xl border border-line px-5 py-2.5 font-medium text-ink transition-colors hover:border-mentee hover:text-mentee"
            >
              Log in
            </Link>
          </div>
